...
async def ch(message: types.Message):
    ...
    s = session.post("https://api.stripe.com/v1/payment_intents/pi_3L3nauGvxtOVt4jK1Idq52y3/confirm",
                     headers=headers)
    r = s.json()
    Guid = r["guid"]
    Muid = r["muid"]
    ...
    head = {
      ...
      "Accept-Language": "es-MX,es-419;q=0.9,es;q=0.8,en;q=07"
    }
    ...
    load = {
      ...
      "payment_method_data[payment_user_agent]": "stripe.js/2Fbc79a771e%3B+stripe-js-v/2Fbc79a771e",
      "use_stripe_sdk": "true",
      "key": "pi_3L3nauGvxtOVt4jK1Idq52y3_secret_3MJJB2Yg8krkT48EBMP9nYCuz",
...
<b>CHKBY</b>➟ <a href="tg://user?id={message.from_user.id}">{message.from_user.first_name}</a>
""")
    elif "Unrecognized request URL" in s.text:
